...
<body>
	...
	<section class="container">
		<form:form modelAtrribute="order.customer" class="form-horizontal">
			<fieldset>
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<input type="submit" id="btnAdd" class="btn btnprimary" value="Doaj" name="_eventId_customerInfoCollected"/>
						<button id="btnCancel" class="btn btn-default" name="_eventId_cancel">Auluj</button>
					</div>
				</div>
			</fieldset>
		</form:form>
